export default function TheoryMode() {
  return (
    <div className="max-w-4xl mx-auto font-sans text-base leading-relaxed space-y-12 pb-20">
      <section>
        <h2 className="text-2xl font-semibold text-foreground mb-6">1. 精度错觉：整数与浮点数的碰撞</h2>
        <p className="mb-6 text-muted-foreground">
          整数和浮点数对现实的表达方式截然不同。整数精确但有界；浮点数广阔但近似。当它们相互转换时，往往会发生意想不到的扭曲。
        </p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div className="border border-border rounded-xl p-6 bg-card shadow-sm transition-colors duration-300">
      ...
      <section>
        <h2 className="text-2xl font-semibold text-foreground mb-6">2. 设计更安全的系统</h2>
        <p className="mb-6 text-muted-foreground">
